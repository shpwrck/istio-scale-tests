...
| `**terraform/rosa-hcp/**`           | Optional Terraform stack for **ROSA HCP** (upstream `terraform-redhat/rosa-hcp/rhcs`), multi-cluster tfvars pattern, and `**helpers/rosa-hcp-aws-quotas.sh`** — see `**terraform/rosa-hcp/README.md`**.                                                  |
