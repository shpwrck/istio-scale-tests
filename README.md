...
| `charts/gitops-hub-mesh-ca-intermediate-appset/` | Helm — ApplicationSet (clusterDecisionResource / Placement) + generator ConfigMap + RBAC for per-cluster intermediate apps.                                                                                              |
