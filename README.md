...
| `**terraform/rosa-hcp/**`                | Optional Terraform stack for **ROSA HCP** (upstream `terraform-redhat/rosa-hcp/rhcs`): one VPC and STS stack per cluster (`for_each`). Outputs API URLs and **`cluster_admin_login`**; kubeconfig is operator-managed — see `**terraform/rosa-hcp/README.md`**.                                                                                                                                                                         |
