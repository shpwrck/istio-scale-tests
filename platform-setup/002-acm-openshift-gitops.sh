...
lint_charts() {
	...
	helm lint "$CHART_GITOPS_HUB_OCM_PLACEMENT_APPSET" -f "${CHART_GITOPS_HUB_OCM_PLACEMENT_APPSET}/values-external-secrets.yaml" --set repo.url=https://example.com/org/repo.git >/dev/null \
